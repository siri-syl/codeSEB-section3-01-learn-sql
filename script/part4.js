...
*/
const PART4_3 = `INSERT INTO user(name,email) values('leeSY','syl@gmail.com')`;
...
/* LEFT JOIN 문을 4-7과 동일하게 쓰고 마지막에 WHERE name is NOT NULL 을 써도 통과됨 */
...
*/
const PART4_10 = `INSERT INTO content(title,body,userId) values('test','yo wassup',1)`;
